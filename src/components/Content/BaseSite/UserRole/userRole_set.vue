    ...
    <div>
        ...
        <div class="actionLine">
            <div class="actionButton">
                <Button type="primary" v-show="status !=0" :icon="buttonInfo.icon[1]" shape="circle" @click="changeStatus(-1)">{{buttonInfo.message[1]}}</Button>
                <Button type="primary" v-show="status !=2" :icon="buttonInfo.icon[0]" shape="circle" @click="changeStatus(1)">{{buttonInfo.message[0]}}</Button>
                <Button type="primary" v-show="status ==2" icon="md-mail" shape="circle" @click="$router.replace('/core/userRole') ">发送验证码</Button>
